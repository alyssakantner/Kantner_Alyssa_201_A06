...
[https://github.com/alyssakantner/Kantner_Alyssa_201_A06](https://github.com/alyssakantner/Kantner_Alyssa_201_A06)
...
rounding <- function(x){
  for(i in 1:nrow(mat_rand)){
    for(j in 1:ncol(mat_rand)){
      if(nchar(as.integer(mat_rand[i,j])) == 2){
        mat_rand[i,j] <- round(mat_rand[i,j], 10)
      }
